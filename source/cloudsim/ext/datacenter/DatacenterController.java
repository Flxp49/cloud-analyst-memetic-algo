...
public class DatacenterController extends DatacenterBroker implements GeoLocatable,
	...
	public DatacenterController(String name, 
		...
		} else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_MEMETIC)){
			this.loadBalancer = new MemeticLoadBalancer(this);
	...
	/**
	 * @return Characteristics of respective VM by ID 
	 */
	public VMCharacteristics getVMCharacteristics(int vmID) {
		return ((VirtualMachine)vmlist.get(vmID)).getCharacteristics();
	}
